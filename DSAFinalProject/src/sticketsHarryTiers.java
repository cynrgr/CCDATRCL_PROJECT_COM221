...
public class sticketsHarryTiers {
	...
	private void initialize() {
		...
		JLabel harrySeatsPoster = new JLabel("");
		ImageIcon img = new ImageIcon(this.getClass().getResource("/harryseat.jpg"));
		harrySeatsPoster.setIcon(img);
		harrySeatsPoster.setBounds(54, 76, 242, 400);
		panel.add(harrySeatsPoster);
